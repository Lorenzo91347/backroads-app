...
export const pageLinks = [
    {id:1, ref:'#home', text:'home'},
    {id:2, ref:'#about', text:'about'},
    {id:3, ref:'#services', text:'services'},
    {id:4, ref:'#tours', text:'tours'},
];
export const socialLinks =[
    {id:1, ref:'https://www.twitter.com',icon:'fab fa-facebook'},
    {id:2, ref:'https://www.twitter.com',icon:'fab fa-twitter'},
    {id:3, ref:'https://www.twitter.com',icon:'fab fa-squarespace'},
];
